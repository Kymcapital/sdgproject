...
use App\Http\Controllers\Backend\ReviewCyclecController;
    ...
    */
    Route::middleware(['auth','sdg.employeetracker'])->group(function () {
        Route::namespace('Frontend')->group(function () {
            ...
            //     Route::get(''.\Str::slug($division->label, '-').'/{id}','DashboardController@index')->name(''.\Str::slug($division->label, '-').'.index');
            // }
        });
    });